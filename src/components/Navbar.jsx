...
const ACTIVE_STYLE = "text-xl font-medium border-b-2 border-amber-400" 
const IN_ACTIVE_STYLE = "text-xl font-light text-amber-100" 

const Navbar = () => {
    return(
        <div className='flex item-center justify-between gap-2 w-full sticky top-0 px-6 py-3 outline-none border-b-2 border-gray-900'>
            <div>
                <NavLink to="/" className='text-2xl font-medium text-amber-400 flex-1'>
                    Abhishek Dave
                </NavLink>
            </div>
