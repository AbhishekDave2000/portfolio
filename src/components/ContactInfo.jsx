            ...
            <div className="felx flex-col my-2">
                ...
                <div className="flex flex-row items-center gap-4 p-2">
                    ...
                    <div className="flex flex-col font-light">
                        <span>Email</span>
                        <a href="mailto:abhishek.dave.ca@gmail.com" className="text-amber-200">abhishek.dave.ca@gmail.com</a>
                    </div>
                </div>
                ...
                <div className="flex flex-row items-center gap-4 p-2">
                    ...
                    <div className="flex flex-col font-light">
                        <span>Linkedin</span>
                        <a href="https://www.linkedin.com/in/abhishek-dave-15b3711a4/" target="_blank" rel="noopener noreferrer" className="text-blue-400">linkedin.com/abhishek-dave</a>
                    </div>
                </div>
                ...
                <div className="flex flex-row items-center gap-4 p-2">
                    ...
                    <div className="flex flex-col font-light">
                        <span>Github</span>
                        <a href="https://github.com/AbhishekDave2000" target="_blank" rel="noopener noreferrer" className="text-zinc-500">github.com/abhishek-dave</a>
                    </div>
                </div>
